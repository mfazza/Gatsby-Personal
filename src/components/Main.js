    ...
    return (
      <div ref={this.props.setWrapperRef} id="main" style={this.props.timeout ? { display: 'flex' } : { display: 'none' }}>
        ...
        <article id="career" className={`${this.props.article === 'career' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{ display: 'none' }}>
          ...
          <p>You can download my most recent resume <a href="https://github.com/mattfazza/Gatsby-Personal/blob/master/src/images/most_recent_resume%5BMattFazza%5D.docx" target="_blank">here</a>.</p>
